...
<div class="container-fluid px-4 py-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        <form action="{{ route('master.product-categories.update', $productCategory) }}" method="POST">
            @csrf
            @method('PUT')
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="code" id="code" value="{{ old('code', $productCategory->code) }}" required
