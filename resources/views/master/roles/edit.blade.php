        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    {{-- Role Stats --}}
                    <div class="bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-200 rounded-lg p-4 mt-6">
                        <h4 class="font-semibold text-gray-800 mb-3">Role Statistics</h4>
                        <div class="space-y-2">
                            <div class="flex items-center justify-between">
                                <span class="text-sm text-gray-600">Current Permissions:</span>
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <span class="text-xs text-gray-600">{{ $role->created_at->format('d M Y') }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mt-6">
                    <div class="flex flex-col space-y-3">
                        ...
                        <a href="{{ route('master.roles.show', $role) }}" class="w-full px-4 py-3 bg-blue-100 text-blue-700 rounded-lg hover:bg-blue-200 transition text-center font-semibold">
                            ...
                            <div class="border border-gray-200 rounded-lg p-4">
                                <div class="flex items-center justify-between mb-3">
                                    ...
                                    <span class="text-xs text-gray-500">
                                        {{ $groupPermissions->whereIn('id', $rolePermissions)->count() }}/{{ $groupPermissions->count() }} selected
                                    </span>
                                </div>

                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                                    @foreach($groupPermissions as $permission)
                                        <label class="flex items-center p-3 bg-gray-50 rounded-lg hover:bg-gray-100 cursor-pointer transition {{ in_array($permission->id, $rolePermissions) ? 'bg-blue-50 border border-blue-200' : '' }}">
