...
<div class="container-fluid px-4 py-6">
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <div class="flex gap-2">
            <a href="{{ route('master.products.show', $product) }}" class="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition">
    ...
    <form action="{{ route('master.products.update', $product) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <select name="type" id="type" required
                                ...
                                <option value="finished_goods" {{ old('type', $product->type) == 'finished_goods' ? 'selected' : '' }}>Finished Goods</option>
                                <option value="spare_parts" {{ old('type', $product->type) == 'spare_parts' ? 'selected' : '' }}>Spare Parts</option>
                    ...
                    <div class="p-6 space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" step="0.01" name="minimum_selling_price" id="minimum_selling_price" value="{{ old('minimum_selling_price', $product->minimum_selling_price) }}"
                    ...
                    <div class="p-6 space-y-6">
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                            ...
                            <div>
                                ...
                                <input type="number" name="maximum_stock" id="maximum_stock" value="{{ old('maximum_stock', $product->maximum_stock) }}"
                                       class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500"
                                       placeholder="0">
                            </div>
                            <div>
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-3 gap-4">
                                <div>
                                    <input type="number" step="0.01" name="length" id="length" value="{{ old('length', $product->length) }}"
                                           class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500"
                                           placeholder="Length">
                                </div>
                                <div>
                                    <input type="number" step="0.01" name="width" id="width" value="{{ old('width', $product->width) }}"
                                           class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500"
                                           placeholder="Width">
                                </div>
                                <div>
                                    <input type="number" step="0.01" name="height" id="height" value="{{ old('height', $product->height) }}"
                                           class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500"
                                           placeholder="Height">
                                </div>
                            </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <input type="number" step="0.01" name="tax_rate" id="tax_rate" value="{{ old('tax_rate', $product->tax_rate) }}"
                                   class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500"
                                   placeholder="0.00">
                        </div>
                    </div>
                    ...
                    <div class="p-6 space-y-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <label class="flex items-center cursor-pointer p-4 border border-gray-300 rounded-lg hover:bg-gray-50">
                                <input type="checkbox" name="is_serialized" value="1" {{ old('is_serialized', $product->is_serialized) ? 'checked' : '' }}
                                       class="w-4 h-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                        ...
                        <div>
                            ...
                            <textarea name="notes" id="notes" rows="3"
                                      class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500"
                                      placeholder="Additional notes (max 1000 characters)">{{ old('notes', $product->notes) }}</textarea>
                        </div>
                    </div>
                </div>
            ...
            <div class="space-y-6">
                ...
                {{-- Audit Info --}}
                <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                    <div class="px-6 py-4 bg-gradient-to-r from-cyan-500 to-cyan-600 border-b">
                        <h3 class="text-lg font-semibold text-white flex items-center">
