{{-- resources/views/master/products/create.blade.php --}}
@extends('layouts.app')
...
<div class="container-fluid px-4 py-6">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-sm text-gray-600 mt-1">Add a new product to the inventory</p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="sku" value="{{ old('sku') }}" required class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 @error('sku') border-red-500 @enderror">
                            @error('sku')
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        ...
                        <div>
                            ...
                            <input type="number" step="0.01" name="weight_kg" value="{{ old('weight_kg') }}" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 @error('weight_kg') border-red-500 @enderror">
                            @error('weight_kg')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" step="0.01" name="length_cm" value="{{ old('length_cm') }}" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 @error('length_cm') border-red-500 @enderror">
                            @error('length_cm')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" step="0.01" name="width_cm" value="{{ old('width_cm') }}" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 @error('width_cm') border-red-500 @enderror">
                            @error('width_cm')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" step="0.01" name="height_cm" value="{{ old('height_cm') }}" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 @error('height_cm') border-red-500 @enderror">
                            @error('height_cm')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        ...
                        <div>
                            ...
                            <input type="number" name="reorder_level" value="{{ old('reorder_level') }}" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 @error('reorder_level') border-red-500 @enderror">
                            @error('reorder_level')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" name="reorder_quantity" value="{{ old('reorder_quantity') }}" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 @error('reorder_quantity') border-red-500 @enderror">
                        ...
                        <div>
                            ...
                            <input type="number" name="min_stock_level" value="{{ old('min_stock_level') }}" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 @error('min_stock_level') border-red-500 @enderror">
                        ...
                        <div>
                            ...
                            <input type="number" name="max_stock_level" value="{{ old('max_stock_level') }}" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 @error('max_stock_level') border-red-500 @enderror">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="number" name="shelf_life_days" value="{{ old('shelf_life_days') }}" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 @error('shelf_life_days') border-red-500 @enderror">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="number" step="0.01" name="temperature_min" value="{{ old('temperature_min') }}" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 @error('temperature_min') border-red-500 @enderror">
                        ...
                        <div>
                            ...
                            <input type="number" step="0.01" name="temperature_max" value="{{ old('temperature_max') }}" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 @error('temperature_max') border-red-500 @enderror">
            ...
            <div class="lg:col-span-1">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
                    ...
                    <div class="mb-4">
                        <div id="image-preview" class="w-full h-48 bg-gray-100 rounded-lg flex items-center justify-center mb-4">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <label class="flex items-center cursor-pointer">
                            <input type="checkbox" name="is_batch_tracked" value="1" {{ old('is_batch_tracked') ? 'checked' : '' }} class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                            <span class="ml-3 text-sm text-gray-700">Batch Tracked</span>
                        </label>

                        {{-- Serial Tracked --}}
                        <label class="flex items-center cursor-pointer">
                            <input type="checkbox" name="is_serial_tracked" value="1" {{ old('is_serial_tracked') ? 'checked' : '' }} class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                            <span class="ml-3 text-sm text-gray-700">Serial Tracked</span>
                        </label>

                        {{-- Expiry Tracked --}}
                        <label class="flex items-center cursor-pointer">
                            <input type="checkbox" name="is_expiry_tracked" value="1" {{ old('is_expiry_tracked') ? 'checked' : '' }} class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                            <span class="ml-3 text-sm text-gray-700">Expiry Tracked</span>
                        </label>

                        {{-- Hazmat --}}
                        <label class="flex items-center cursor-pointer">
                            <input type="checkbox" name="is_hazmat" value="1" {{ old('is_hazmat') ? 'checked' : '' }} class="rounded border-gray-300 text-red-600 focus:ring-red-500">
