...
<div class="container-fluid px-4 py-6">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-sm text-gray-600 mt-1">Update unit information</p>
        </div>
            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="short_code" id="short_code" value="{{ old('short_code', $unit->short_code) }}" 
                        ...
                        <div>
                            ...
                            <select name="type" id="type" 
                                ...
                                <option value="base" {{ old('type', $unit->type) === 'base' ? 'selected' : '' }}>Base</option>
                        ...
                        <div>
                            ...
                            <label class="inline-flex items-center cursor-pointer">
                                <input type="checkbox" name="is_active" value="1" {{ old('is_active', $unit->is_active) ? 'checked' : '' }} class="sr-only peer">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" name="base_unit_conversion" id="base_unit_conversion" 
                                   value="{{ old('base_unit_conversion', $unit->base_unit_conversion) }}" 
                                   step="0.0001" min="0"
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="3" 
                              ...
                              placeholder="Additional notes or description about this unit...">{{ old('description', $unit->description) }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
