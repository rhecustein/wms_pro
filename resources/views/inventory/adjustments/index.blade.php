...
<div class="container-fluid px-4 py-6">
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="{{ route('inventory.adjustments.create') }}" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition">
        ...
        <form method="GET" action="{{ route('inventory.adjustments.index') }}">
            <div class="grid grid-cols-1 md:grid-cols-6 gap-4">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="search" value="{{ request('search') }}" placeholder="Adjustment Number, Notes..." class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                </div>
                ...
                <div>
                    ...
                    <select name="adjustment_type" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex items-center justify-end space-x-2">
                                    <a href="{{ route('inventory.adjustments.show', $adjustment) }}" class="text-blue-600 hover:text-blue-900" title="View Details">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    
                                    @if($adjustment->status === 'draft')
                                        <a href="{{ route('inventory.adjustments.edit', $adjustment) }}" class="text-yellow-600 hover:text-yellow-900" title="Edit">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <form action="{{ route('inventory.adjustments.destroy', $adjustment) }}" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this adjustment?')">
                                            @csrf
                                            @method('DELETE')
                            ...
                            <td colspan="8" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center">
                                    <div class="w-20 h-20 bg-gray-100 rounded-full flex items-center justify-center mb-4">
                                        <i class="fas fa-adjust text-4xl text-gray-400"></i>
                                    </div>
                                    <h3 class="text-lg font-semibold text-gray-800 mb-2">No Adjustments Found</h3>
                                    <p class="text-gray-600 mb-4">Get started by creating your first stock adjustment</p>
                                    <a href="{{ route('inventory.adjustments.create') }}" class="px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition">
                                        <i class="fas fa-plus mr-2"></i>New Adjustment
                                    </a>
                                </div>
                            </td>
