{{-- resources/views/inventory/opnames/create.blade.php --}}
@extends('layouts.app')
...
<div class="container-fluid px-4 py-6">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-sm text-gray-600 mt-1">Plan new physical inventory count</p>
        </div>
    ...
    <form action="{{ route('inventory.opnames.store') }}" method="POST" id="opnameForm">
        @csrf
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" value="{{ $opnameNumber }}" readonly class="w-full rounded-lg border-gray-300 bg-gray-50 focus:border-blue-500 focus:ring-blue-500">
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Opname Date *</label>
                            <input type="datetime-local" name="opname_date" value="{{ old('opname_date', now()->format('Y-m-d\TH:i')) }}" required class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <div class="grid grid-cols-3 gap-3">
                                <label class="flex items-center p-3 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-blue-500 transition">
                                    <input type="radio" name="opname_type" value="full" {{ old('opname_type') === 'full' ? 'checked' : '' }} required class="mr-2">
                                    <div>
                                ...
                                <label class="flex items-center p-3 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-blue-500 transition">
                                    <input type="radio" name="opname_type" value="cycle" {{ old('opname_type', 'cycle') === 'cycle' ? 'checked' : '' }} required class="mr-2">
                                    <div>
                                ...
                                <label class="flex items-center p-3 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-blue-500 transition">
                                    <input type="radio" name="opname_type" value="spot" {{ old('opname_type') === 'spot' ? 'checked' : '' }} required class="mr-2">
                                    <div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="notes" rows="3" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">{{ old('notes') }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="space-y-3">
                        <button type="submit" class="w-full px-4 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition font-semibold">
                            <i class="fas fa-save mr-2"></i>Create Opname
                        </button>
                        
                        <a href="{{ route('inventory.opnames.index') }}" class="block w-full px-4 py-3 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition text-center font-semibold">
                ...
                <div class="bg-blue-50 rounded-xl border border-blue-200 p-6">
                    ...
                    <ul class="text-xs text-blue-800 space-y-2">
                        <li class="flex items-start">
                            ...
                            <span>Add all items you want to count</span>
                        </li>
                        <li class="flex items-start">
                            <i class="fas fa-check-circle mr-2 mt-0.5"></i>
                            <span>System quantity will be used as baseline</span>
                        </li>
                        <li class="flex items-start">
                            <i class="fas fa-check-circle mr-2 mt-0.5"></i>
                            <span>Start counting after creating the opname</span>
                        </li>
                    </ul>
                </div>
...
document.getElementById('warehouse_id').addEventListener('change', function() {
    ...
    // Update storage bins for existing items
