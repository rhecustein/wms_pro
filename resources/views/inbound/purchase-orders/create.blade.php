...
<div class="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-gray-50">
    <div class="container-fluid px-4 py-8 max-w-[1800px] mx-auto">
        ...
        <div class="mb-8">
            ...
            <nav class="flex mb-4" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li>
                        <div class="flex items-center">
                            <i class="fas fa-chevron-right text-gray-400 mx-2 text-xs"></i>
                            <span class="text-sm font-medium text-gray-900">Create New</span>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    ...
                    <p class="text-sm text-gray-600 mt-2 ml-16">Create a new purchase order for your inventory</p>
                </div>
                <a href="{{ route('inbound.purchase-orders.index') }}" class="px-6 py-2.5 bg-white border-2 border-gray-200 text-gray-700 rounded-xl hover:border-blue-500 hover:text-blue-600 transition-all duration-200 shadow-sm hover:shadow-md flex items-center gap-2 font-medium">
        ...
        {{-- Form --}}
        <form action="{{ route('inbound.purchase-orders.store') }}" method="POST" id="poForm">
            @csrf
                        ...
                        <div class="p-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="text" value="{{ $poNumber }}" class="w-full pl-10 pr-4 py-2.5 rounded-xl border-2 border-gray-200 bg-gray-50 cursor-not-allowed font-mono font-bold text-gray-600" readonly>
                                ...
                                <div>
                                    ...
                                    <input type="date" name="po_date" value="{{ old('po_date', date('Y-m-d')) }}" class="w-full px-4 py-2.5 rounded-xl border-2 border-gray-200 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all duration-200 @error('po_date') border-red-500 @enderror" required>
                                    @error('po_date')
                                ...
                                <div>
                                    ...
                                    <input type="date" name="expected_delivery_date" value="{{ old('expected_delivery_date') }}" class="w-full px-4 py-2.5 rounded-xl border-2 border-gray-200 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all duration-200 @error('expected_delivery_date') border-red-500 @enderror">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="payment_terms" id="payment_terms" value="{{ old('payment_terms') }}" placeholder="e.g., Net 30, COD" class="w-full px-4 py-2.5 rounded-xl border-2 border-gray-200 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all duration-200 @error('payment_terms') border-red-500 @enderror">
                                    @error('payment_terms')
                                        <p class="text-red-500 text-xs mt-1.5 flex items-center gap-1">
                                            <i class="fas fa-exclamation-circle"></i>
                                            {{ $message }}
                                ...
                                <div>
                                    ...
                                    <input type="number" name="payment_due_days" id="payment_due_days" value="{{ old('payment_due_days', 30) }}" min="0" class="w-full px-4 py-2.5 rounded-xl border-2 border-gray-200 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all duration-200">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="reference_number" value="{{ old('reference_number') }}" placeholder="Optional reference" class="w-full px-4 py-2.5 rounded-xl border-2 border-gray-200 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all duration-200">
                                </div>
                            </div>
                            ...
                            <div class="mt-6 pt-6 border-t border-gray-100">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                    <div class="md:col-span-2">
                                        ...
                                        <textarea name="shipping_address" rows="2" placeholder="Enter shipping address..." class="w-full px-4 py-2.5 rounded-xl border-2 border-gray-200 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all duration-200">{{ old('shipping_address') }}</textarea>
                                    </div>
                                    <div>
                                        <label class="block text-sm font-semibold text-gray-700 mb-2">
                                            <i class="fas fa-truck text-gray-400 mr-1"></i>
                                        ...
                                        <input type="text" name="shipping_method" value="{{ old('shipping_method') }}" placeholder="e.g., Courier, Pickup" class="w-full px-4 py-2.5 rounded-xl border-2 border-gray-200 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all duration-200">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                        ...
                        <div class="p-6">
                            ...
                            <div id="empty-state" class="text-center py-12">
                                ...
                                <h3 class="text-lg font-bold text-gray-800 mb-2">No Items Added</h3>
                                <p class="text-gray-600 mb-4">Click "Add Item" button to add products to this purchase order</p>
                                <button type="button" onclick="addItem()" class="px-6 py-3 bg-gradient-to-r from-purple-600 to-purple-700 text-white rounded-xl hover:from-purple-700 hover:to-purple-800 transition-all duration-200 shadow-lg shadow-purple-500/30 inline-flex items-center gap-2 font-medium">
                                    <i class="fas fa-plus"></i>
                                    Add Your First Item
                                </button>
                            </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                        ...
                        <div class="p-6 space-y-5">
                            <div>
                                ...
                                <textarea name="notes" rows="3" placeholder="Add any additional notes or comments..." class="w-full px-4 py-2.5 rounded-xl border-2 border-gray-200 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all duration-200">{{ old('notes') }}</textarea>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea name="terms_conditions" rows="3" placeholder="Enter terms and conditions..." class="w-full px-4 py-2.5 rounded-xl border-2 border-gray-200 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all duration-200">{{ old('terms_conditions') }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden sticky top-6">
                        ...
                        <div class="p-6">
                            ...
                            <div class="space-y-4 py-4 border-y border-gray-100">
                                ...
                                <div>
                                    <div class="flex justify-between items-center mb-2">
                                        ...
                                        <input type="number" name="tax_rate" id="tax_rate" value="{{ old('tax_rate', 0) }}" min="0" max="100" step="0.01" class="w-24 px-3 py-1.5 text-right rounded-lg border-2 border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/10 text-sm font-semibold" onchange="calculateTotal()">
                                    </div>
                                    <div class="flex justify-between items-center">
                                ...
                                <div>
                                    <div class="flex justify-between items-center mb-2">
                                        ...
                                        <input type="number" name="discount_rate" id="discount_rate" value="{{ old('discount_rate', 0) }}" min="0" max="100" step="0.01" class="w-24 px-3 py-1.5 text-right rounded-lg border-2 border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/10 text-sm font-semibold" onchange="calculateTotal()">
                                    </div>
                                    <div class="flex justify-between items-center">
                                ...
                                <div>
                                    <div class="flex justify-between items-center mb-2">
                                        ...
                                        <input type="number" name="shipping_cost" id="shipping_cost" value="{{ old('shipping_cost', 0) }}" min="0" step="0.01" class="w-32 px-3 py-1.5 text-right rounded-lg border-2 border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/10 text-sm font-semibold" onchange="calculateTotal()">
                                    </div>
                                </div>
                                ...
                                <div>
                                    <div class="flex justify-between items-center mb-2">
                                        ...
                                        <input type="number" name="other_cost" id="other_cost" value="{{ old('other_cost', 0) }}" min="0" step="0.01" class="w-32 px-3 py-1.5 text-right rounded-lg border-2 border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/10 text-sm font-semibold" onchange="calculateTotal()">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mt-6 space-y-3">
                                ...
                                <a href="{{ route('inbound.purchase-orders.index') }}" class="w-full px-4 py-3 bg-gray-100 text-gray-700 rounded-xl hover:bg-gray-200 transition-all duration-200 font-semibold text-center flex items-center justify-center gap-2">
                            ...
                            {{-- Info Box --}}
                            <div class="mt-6 p-4 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl border border-blue-100">
                                ...
                                <ul class="text-xs text-blue-800 space-y-1.5">
                                    <li class="flex items-start gap-2">
                                        ...
                                        <span>PO will be created as draft status</span>
                                    </li>
                                    <li class="flex items-start gap-2">
                                        <i class="fas fa-check-circle mt-0.5 text-blue-600"></i>
                                        <span>Can be edited before submission</span>
                                    </li>
                                    <li class="flex items-start gap-2">
                                        <i class="fas fa-check-circle mt-0.5 text-blue-600"></i>
