...
<div class="container-fluid px-4 py-6">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-sm text-gray-600 mt-1">Manage and track putaway operations</p>
        </div>
        <div class="flex space-x-3">
            <a href="{{ route('inbound.putaway-tasks.pending') }}" class="px-4 py-2 bg-yellow-600 text-white rounded-lg hover:bg-yellow-700 transition">
            ...
            <a href="{{ route('inbound.putaway-tasks.create') }}" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition">
                <i class="fas fa-plus mr-2"></i>New Putaway Task
            </a>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
        <form method="GET" action="{{ route('inbound.putaway-tasks.index') }}">
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                @if($task->batch_number)
                                    <div class="text-xs text-gray-500">Batch: {{ $task->batch_number }}</div>
                                @endif
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                {!! $task->priority_badge !!}
                        ...
                        <tr>
                            <td colspan="9" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center">
                                    ...
                                    <h3 class="text-lg font-semibold text-gray-800 mb-2">No Putaway Tasks Found</h3>
                                    <p class="text-gray-600 mb-4">Get started by creating your first putaway task</p>
                                    <a href="{{ route('inbound.putaway-tasks.create') }}" class="px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition">
                                        <i class="fas fa-plus mr-2"></i>New Putaway Task
                                    </a>
                                </div>
                            </td>
